...
const linkAction = () => {
    const navMenu = document.getElementById('nav-menu');
    navMenu.classList.remove('show-menu'); // Fixed class name
};
...
const scrollHeader = () => {
    ...
    this.scrollY >= 50 ? header.classList.add('bg-header') // Fixed method name
...
const iconTheme = 'ri-sun-line'; // Fixed icon class name
